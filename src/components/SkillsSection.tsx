  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'AWS', level: 50, color: 'from-yellow-400 to-yellow-600' },
        {
          name: 'GitHub Actions',
          level: 50,
          color: 'from-indigo-400 to-indigo-600',
        },
        { name: 'Vercel', level: 80, color: 'from-green-600 to-green-800' },
      ],
    },
    {
      title: 'Tools & Others',
      skills: [
        ...
        { name: 'Notion', level: 90, color: 'from-blue-600 to-blue-800' },
        {
          name: 'Cursor',
          level: 85,
          color: 'from-orange-400 to-orange-600',
        },
        { name: 'Figma', level: 60, color: 'from-pink-400 to-pink-600' },
      ],
    },
  ];
  ...
  return (
    <section id="skills" className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl text-white mb-6">Tech Stack</h2>
